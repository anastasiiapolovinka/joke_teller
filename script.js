...
function tellMe(joke) {
   VoiceRSS.speech({
      key: 'fbe30b865b3a409c8ef15e0bd64ec60f',
      src: joke,
      hl: 'en-us',
      v: 'Linda',
      r: 0, 
...
// Get joke from API Joke
async function getJokes() {
   let joke = '';
   const apiUrl = 'https://v2.jokeapi.dev/joke/Programming?blacklistFlags=nsfw,religious,political,racist,sexist&idRange=0-190';
   try {
